...
```sh
mix usage_rules.search_docs "search term" -p ash -p ash_authentication_phoenix -p ash_phoenix -p ash_oban -p ash_postgres -p ash_json_api -p ash_authentication -p ash_graphql
```
